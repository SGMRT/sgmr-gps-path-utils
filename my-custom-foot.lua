  ...
  return {
    ...
    speeds = Sequence {
      highway = {
        ...
        track = 7,         -- 비포장도로, 농로 (일반 보도보다 빠르게)
        path = 6,          -- 공원 산책로, 오솔길
        steps = walking_speed * 0.1, -- 계단은 속도를 매우 낮춰 회피하도록 설정
        pedestrian = 5,    -- 보행자 전용 구역
        platform = 5,
        footway = 5,     -- 인도, 보도
        pier = 4
      },
    ...
    surface_speeds = {
      fine_gravel = walking_speed * 0.9,
      gravel = walking_speed * 0.8,
      pebblestone = walking_speed * 0.75,
      mud = walking_speed * 0.5, -- 진흙길은 대폭 감속
      sand = walking_speed * 0.4  -- 모래사장은 거의 달릴 수 없으므로 페널티 크게
    },
